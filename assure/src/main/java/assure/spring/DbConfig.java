...
public class DbConfig {
    public static final String PACKAGE_POJO = "assure.pojo";

    //todo naming with assure_
...
//		logger.info("jdbcDriver: " + jdbcDriver + ", jdbcUrl: " + jdbcUrl + ", jdbcUsername: " + jdbcUsername);
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        jpaProperties.put("hibernate.physical_naming_strategy", new SnakeCaseNamingStrategy("assure_"));
